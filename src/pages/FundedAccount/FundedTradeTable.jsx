// FundedTradeTable.jsx (Optimized with Mobile Card View)
    ...
    return (
      <div className="bg-white p-4 rounded-xl shadow-lg border border-gray-100 space-y-3">
        ...
        <div className="flex justify-between items-center border-b pb-2">
          <span className="text-xl font-bold text-gray-900">{trade.pair}</span>
          <span
        ...
        <div className="grid grid-cols-2 gap-y-2 gap-x-4 text-sm">
          {/* Row 1: Date/Day (Content combined and reduced for mobile) */}
          ...
          {/* Row 2: Net USD (Prioritized stat) */}
          ...
          {/* Row 3: Gain Pips (Prioritized stat) */}
          <div className="flex justify-between">
        ...
        <div className="flex justify-end gap-2 pt-3 border-t">
          <button
            ...
            className="flex items-center gap-1 bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded-full text-sm transition shadow-sm"
          >
            <Pencil size={16} />
            Edit
          </button>
          ...
          <button
            ...
            className="flex items-center gap-1 bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-full text-sm transition shadow-sm"
          >
            <Trash2 size={16} />
            Delete
          </button>
