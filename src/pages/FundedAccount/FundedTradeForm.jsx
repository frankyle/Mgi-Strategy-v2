...
function FundedTradeForm({ initialData, onSubmit, onClose }) {
  ...
  const [form, setForm] = useState(
    initialData || {
      ...
      pair: "",
      signal: "Buy",    // default dropdown value
      risk_usd: 25,      // default initial value
      gain_usd: 40,      // default initial value
      risk_pips: 20,    // default initial value
      gain_pips: 40,    // default initial value
    }
  );
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-md w-full max-w-md mx-auto space-y-4">
      <h2 className="text-xl font-semibold text-gray-700 mb-2">
        {initialData ? "Edit Trade" : "New Funded Trade"}
      </h2>
...
export default FundedTradeForm;
